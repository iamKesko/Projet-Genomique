...
* Le génome de référence dans un fichier FASTA
* Les séquences à aligner dans un fichier FATSQ
* *Les fichiers ZIP complet étants volumineux (>100Mo), ils sont accesibles dans la section Releases*
